...
%pandoc 144_pentades5.md   --template=tian-dao-article2.tex   -o 144_pentades5.pdf   --pdf-engine=xelatex   --bibliography=references.bib   --csl=american-physics-society.csl   --citeproc   --toc --toc-depth=2
